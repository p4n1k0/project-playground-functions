...
function catAndMouse(mouse, cat1, cat2) {
  ...
  if (distanciaCat2 < distanciaCat1) return 'cat2';
...
function fizzBuzz(numbers) {
  ...
  for (let i = 0; i < numbers.length; i += 1) {
    if (numbers[i] % 3 === 0 && numbers[i] % 5 !== 0) array.push("fizz");
    else if (numbers[i] % 3 !== 0 && numbers[i] % 5 === 0) array.push("buzz");
    else if (numbers[i] % 3 === 0 && numbers[i] % 5 === 0) array.push("fizzBuzz");
    else array.push("bug!")
  }
  return array;
}
...
function techList(technologies, name) {
  ...
  if (technologies.length === 0) array = 'Vazio!';
  return array;
}
